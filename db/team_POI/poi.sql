...
INSERT INTO poi (poi_id, descriptionGER, descriptionENG) VALUES (
    3, 
    'Hier finden Sie Flyer zu Nachhilfe, Schreibberatung und Workshops. Schauen Sie sich gerne um vielleicht ist etwas Passendes fuer Sie dabei.', 
    'Here you can find flyers about tutoring, writing support, and workshops. Feel free to take a look - there might be something suitable for you.'
);

-- Spendenbox
INSERT INTO poi (poi_id, descriptionGER, descriptionENG) VALUES (
    4, 
    'Hier koennen Sie mit Hygieneartikeln obdachlosen Menschen helfen. Spenden Sie verpackte Binden, Tampons oder Pflegeprodukte. Mehr Infos unter Social Period.', 
    'Here you can help people experiencing homelessness by donating hygiene products. Please give sealed pads, tampons, or care items. Learn more at Social Period.'
);

-- Karten Validierer
INSERT INTO poi (poi_id, descriptionGER, descriptionENG) VALUES (
    5, 
    'Sie sind nun beim Karten Validierer. Hier aktualisieren Sie die Gueltigkeit Ihrer Studierendenkarte. Bitte schieben Sie dazu Ihre Karte vollstaendig mit dem Datum nach oben ein und warten Sie, bis der Vorgang abgeschlossen ist.', 
    'You are now at the card validator. Here, you can update the validity of your student card. Please insert your card completely with the date facing upward and wait until the process is completed.'
);

--Kartenausgabe Gerät
INSERT INTO poi (poi_id, descriptionGER, descriptionENG) VALUES (
    6, 
    'Sie stehen nun vor dem Kartenausgabe Geraet. Hier koennen Sie ihre Studierendenkarte erstellen. Druecken Sie dafuer einfach den gruenen Knopf ''Create Card'' auf dem Bildschirm.', 
    'You are now standing in front of the card issuing machine. Here, you can create your student card. Simply press the green ''Create Card'' button on the screen.'
);

--Mülleimer
INSERT INTO poi (poi_id, descriptionGER, descriptionENG) VALUES (
    7, 
    'Hier befindet sich der Muelleimer. Bitte trennen Sie Ihren Muell richtig.', 
    'Here you can find the waste bin. Please make sure to separate your waste correctly.'
);

-- Kaffeeautomat
INSERT INTO poi (poi_id, descriptionGER, descriptionENG) VALUES (
    8, 
    'Am Kaffeeautomaten koennen Sie aus verschiedenen kaffeehaltigen Getraenken waehlen. Die Bezahlung erfolgt ausschließlich mit Karte. Tippen Sie einfach auf Ihr Wunschgetraenk, bezahlen Sie - und schon wird es frisch fuer Sie zubereitet.', 
    'At the coffee machine, you can choose from a variety of coffee beverages. Payment is by card only. Simply tap your desired drink, make the payment, and it will be freshly prepared for you right away.'
);
